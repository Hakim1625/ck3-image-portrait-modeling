...
class dataset_generator():
    ...
    def _set_age(self, age):
        x, y = auto.locateCenterOnScreen('./utils/dependencies/button.png', region=dataset_generator.landmarks['upper_region'], confidence=0.6)

        length = dataset_generator.landmarks['slider_bounds'][1] - dataset_generator.landmarks['slider_bounds'][0] + 25
        x_target = dataset_generator.landmarks['slider_bounds'][0] + ((age/100)*length)
    ...
    def _set_ethnicity(self, ethnicity):
        ...
        for letter in ethnicity: auto.press(letter)
    ...
    def _set_animation(self, animation):
        ...
        for letter in animation: auto.press(letter)
    ...
    def _randomize_clothes(self):
        ...
        for letter in 'clothes': auto.press(letter)
        ...
        x, y = auto.locateCenterOnScreen('./utils/dependencies/button.png', region=dataset_generator.landmarks['lower_region'], confidence=0.6, grayscale=True)

        length = dataset_generator.landmarks['slider_bounds'][1] - dataset_generator.landmarks['slider_bounds'][0] + 25
        x_target = dataset_generator.landmarks['slider_bounds'][0] + (random.random()*length)
    ...
    def _randomize_hair(self):
        ...
        for letter in 'hairstyle': auto.press(letter)
    ...
    def _switch_angles(self, angle):
        ...
        for letter in dataset_generator.angles[angle]: auto.press(letter)
    ...
    def _screenshot(self, filename, age, gender):
        ...
        if age < 16: 
            if gender == 'male':
                auto.screenshot(filename, dataset_generator.landmarks['boy_region'])
            else:
                auto.screenshot(filename, dataset_generator.landmarks['girl_region'])
        else:
            if gender == 'male':
                auto.screenshot(filename, dataset_generator.landmarks['male_region'])
            else:
                auto.screenshot(filename, dataset_generator.landmarks['female_region'])
